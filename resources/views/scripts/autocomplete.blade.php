  ...
  var Dropdown = function (_Component2) {
    ...
    _createClass(Dropdown, [{
      ...
      value: function open() {
        ...
        //alan
        try{
          document.getElementById('searchList_' + this.options.focusId).focus();
        }catch(e){
  ...
  var FormSelect = function (_Component20) {
    ...
    _createClass(FormSelect, [{
      ...
      //alan
			...
			var element = $('<div class="input-field col s12"><input id="searchList_' + document.getElementsByName('searchListName').length + '" name="searchListName" type="text" class="dropDownsearch" style="margin: 5px 0px 16px 15px; width: 96%;"> <label for="first_name">'+ placeholder + '</label></div>');
      ...
      $(this.dropdownOptions).append(element);
        ...
        if (!this.el.disabled) {
          ...
          //alan
          this.dropdown.options.focusId = document.getElementsByName('searchListName').length-1;
